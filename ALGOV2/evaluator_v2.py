"""
Enhanced Evaluator with Database Support

Runs all strategies on all assets and timeframes using SQLite database
"""
import pandas as pd
import numpy as np
...
class StrategyEvaluatorV2:
    """Evaluate all strategies using database storage"""
    ...
    def evaluate_all(self):
        ...
        print("=" * 70)
        print("BACKTESTING EVALUATION (Database Mode)")
        print("=" * 70)
        ...
        print(f"\nDatabase: {stats['total_candles']:,} candles across {stats['total_pairs']} pairs")
        print("=" * 70)
    ...
    def _generate_text_summary(self, df):
        ...
        with open(summary_path, 'w') as f:
            f.write("=" * 70 + "\n")
            f.write("BACKTEST RESULTS SUMMARY (Database Mode)\n")
            f.write("=" * 70 + "\n\n")
