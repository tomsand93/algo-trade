"""
Quick test script to run a single strategy on one asset/timeframe
Useful for testing and debugging individual strategies
"""
import pandas as pd
...
def test_single_strategy():
    ...
    if df is None or df.empty:
        print(f"❌ No data found. Run 'python run.py download' first")
        return
