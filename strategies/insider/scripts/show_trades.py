...
test_configs = [
    ...
    },
    {
        ...
        "take": "0.16",
        "trail": 2,
        "max_hold": 365,  # Effectively no max hold
    },
    {
    ...
    {
        "name": "Tighter Trail (Trail at 0.5R/1.5R)",
        "stop": "0.08",
        "take": "0.16",
        "trail": 1.5,  # Trail sooner
        "max_hold": 60,
    },
    {
        "name": "Larger Take Profit (20% TP, Trail 1R/2R)",
        "stop": "0.08",
        "take": "0.20",
        "trail": 2,
        "max_hold": 60,
...
for cfg in test_configs:
    ...
    ret = float(result["summary"]["total_return"]) * 100
    dd = float(result["summary"]["max_drawdown"]) * 100
    sharpe = result["summary"]["sharpe_ratio"]
    wr = float(result["trades"]["win_rate"]) * 100
